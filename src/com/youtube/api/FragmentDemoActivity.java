 ...
 * simple application that shows a YouTube Video in a
 * {@link YouTubePlayerFragment}.
 * <p>
 * Note, this sample app extends from {@link YouTubeFailureRecoveryActivity} to
 * handle errors, which itself extends {@link YouTubeBaseActivity}. However, you
 * are not required to extend {@link YouTubeBaseActivity} if using
 * {@link YouTubePlayerFragment}s.
 */
@SuppressLint("NewApi")
