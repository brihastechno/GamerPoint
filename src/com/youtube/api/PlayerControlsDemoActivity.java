...
/**
 * A simple YouTube Android API demo application demonstrating the use of
 * {@link YouTubePlayer} programmatic controls.
 */
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity
	...
	private static final ListEntry[] ENTRIES = {
			...
			new ListEntry("Playlist: Google I/O 2012", "PL56D792A831D0C362",
					true) };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((RadioButton) findViewById(R.id.style_default))
				.setOnCheckedChangeListener(this);
		((RadioButton) findViewById(R.id.style_minimal))
				.setOnCheckedChangeListener(this);
	...
	private static final int parseInt(String intString, int defaultValue) {
		try {
			return intString != null ? Integer.valueOf(intString)
					: defaultValue;
	...
	private String getTimesText() {
		...
		return String.format("(%s/%s)", formatTime(currentTimeMillis),
