 ...
 */
public class StandalonePlayerDemoActivity extends Activity implements
		View.OnClickListener {

	private static final int REQ_START_STANDALONE_PLAYER = 1;
	private static final int REQ_RESOLVE_SERVICE_MISSING = 2;

	private static String VIDEO_ID = "QK8mJJJvaes";
	...
	public void onClick(View v) {
		...
		int startTimeMillis = parseInt(startTimeEditText.getText().toString(),
				0) * 1000;
		...
		if (v == playVideoButton) {
			intent = YouTubeStandalonePlayer.createVideoIntent(this,
					DeveloperKey.DEVELOPER_KEY, VIDEO_ID, startTimeMillis,
					autoplay, lightboxMode);
		} else if (v == playPlaylistButton) {
			intent = YouTubeStandalonePlayer.createPlaylistIntent(this,
					DeveloperKey.DEVELOPER_KEY, PLAYLIST_ID, startIndex,
