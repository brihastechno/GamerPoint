...
public class Twitter_Home_TimeLine extends Activity {

	public static final String ENCODING = "UTF-8";
	private static final String postURL = "http://api.twitter.com/1.1/statuses/update.json";
			...
			protected void onPostExecute(HttpResponse response) {
				...
				if (response != null) {
					try {
						...
						adapter = new LazyAdapterFeed(
								Twitter_Home_TimeLine.this, tweets);
	...
	public class LazyAdapterFeed extends BaseAdapter {
		private Twitter_Home_TimeLine activity;
		...
		public LazyAdapterFeed(Twitter_Home_TimeLine list_Tweets_fetch,
				ArrayList<Tweet> tweet_feed) {
	...
	public class Progress_Fetch_Tweets extends
		...
		protected void onPostExecute(HttpResponse response) {
			...
			if (response != null) {
				try {
					parseGetHomeTimelineResponse(response);
					adapter = new LazyAdapterFeed(Twitter_Home_TimeLine.this,
							tweets);
					list.setAdapter(adapter);
