 ...
 * 
 */
public class ResourceImageAdapter_Music extends AbstractCoverFlowImageAdapter {

	/** The Constant TAG. */
	private static final String TAG = ResourceImageAdapter_Music.class
			.getSimpleName();
	...
	private static final int[] DEFAULT_RESOURCE_LIST = {
			R.drawable.icon_music_big, R.drawable.icon_music_big,
			R.drawable.icon_music_big, R.drawable.icon_music_big, };
	 ...
	 *            context
	 */
	public ResourceImageAdapter_Music(final Context context) {
		super();
