 ...
 * 
 */
public class ResourceImageAdapter_Next extends AbstractCoverFlowImageAdapter {

	/** The Constant TAG. */
	private static final String TAG = ResourceImageAdapter_Next.class
			.getSimpleName();
	...
	private static final int[] DEFAULT_RESOURCE_LIST = { R.drawable.icon_shop,
			R.drawable.icon_shop1, R.drawable.icon_music_big,
			R.drawable.icon_shop2, };
	 ...
	 *            context
	 */
	public ResourceImageAdapter_Next(final Context context) {
		super();
