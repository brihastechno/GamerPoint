...
package com.youtubeapidemo.adapter;
...
public final class DemoArrayAdapter extends ArrayAdapter<DemoListViewItem> {
	...
	public DemoArrayAdapter(Context context, int textViewResourceId,
			List<DemoListViewItem> objects) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		TextView disabledText = (TextView) view
				.findViewById(R.id.list_item_disabled_text);
	...
	public boolean areAllItemsEnabled() {
		// have to return true here otherwise disabled items won't show a
		// divider in the list.
		return true;
	}
