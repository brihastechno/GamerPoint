...
import com.picture.slides.AbstractCoverFlowImageAdapter;
import com.picture.slides.ReflectingImageAdapter;

public class CoverFlow_Shop_Tab extends Gallery {
	...
	public CoverFlow_Shop_Tab(final Context context) {
		super(context);
		this.setStaticTransformationsEnabled(true);
	}

	public CoverFlow_Shop_Tab(final Context context, final AttributeSet attrs) {
	...
	private void parseAttributes(final Context context, final AttributeSet attrs) {
		...
		try {
			...
			imageHeight = a
					.getDimension(R.styleable.CoverFlow_imageHeight, 420);
