...
public class InstagramApp {
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					JSONObject jsonObj = (JSONObject) new JSONTokener(response)
							.nextValue();
					String profile_pic = jsonObj.getJSONObject("data")
							.getString("profile_picture");
					String name = jsonObj.getJSONObject("data").getString(
							"full_name");
					String followedby = jsonObj.getJSONObject("data")
							.getJSONObject("counts").getString("followed_by");
					Log.i(TAG, "Got name: " + followedby);
					String follows = jsonObj.getJSONObject("data")
							.getJSONObject("counts").getString("follows");
					Log.i(TAG, "Got name: " + followedby);

					String bio = jsonObj.getJSONObject("data").getString("bio");
					Log.i(TAG, "Got name: " + name + ", bio [" + bio + "]");
					mSession.putprofile_url(profile_pic, name, followedby,
							follows);
				} catch (Exception ex) {
					what = WHAT_ERROR;
					ex.printStackTrace();
	...
	public String get_profile() {
		return mSession.getProfile_pic();
	}

	public String getUserFull() {
		return mSession.getUserFull();
	}

	public String getfollowedby() {
		return mSession.getfollowedby();
	}

	public String getfollows() {
		return mSession.getfollows();
	}
}